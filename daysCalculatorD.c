 ...
 *   Execution: ./daysCalculatorD 23-8-2019 25-9-2019 (include)
 */
...
int main ( int argc, char *argv[] ) {
   ...
   /*Time code taken from tutorialspoint.com/c_standard_library/c_function_strftime.htm */
   ...
   if ( argc < 3 ) {
      printf ( "Usage: ./daysCalculatorD dd1-mm1-yyyy1 dd2-mm2-yyyy2 (include)\n" );
      exit ( 1 );
   } else {  
   ...
   /* Calculate the day of the year for both start and finish */
